...
function SpellingListUI(props: SpellingListUIProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
      <div className="fixed top-20 right-6 z-50 rounded-2xl border border-slate-200 bg-white/95 px-4 py-2.5 shadow-xl backdrop-blur">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="text-center">
              <p className="text-[9px] font-medium text-slate-500">正确</p>
              <p className="font-mono text-xs font-bold text-emerald-600">{stats.correct}</p>
            </div>
            <div className="text-center">
              <p className="text-[9px] font-medium text-slate-500">错误</p>
              <p className="font-mono text-xs font-bold text-rose-500">{stats.wrong}</p>
            </div>
            <div className="text-center">
              <p className="text-[9px] font-medium text-slate-500">准确率</p>
